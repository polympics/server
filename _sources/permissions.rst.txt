...
:superscript:`\*1` You can give users the ``manage_own_team`` permission even if you do not have the ``manage_permissions`` permission, if you have the ``manage_own_team`` permission and are a member of the same team as them. You cannot grant permissions you do not have.
